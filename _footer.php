  ...
  <footer class="bg-gray-800 mt-20">
      <div class="mx-auto w-full max-w-screen-xl">
          <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
              <div>
                  ...
                  <ul class="text-gray-400 font-medium">
                      ...
                      <li class="mb-4">
                          <a href="account.php" class="hover:underline">Profile</a>
                      </li>
                      <li class="mb-4">
              ...
              <div>
                  ...
                  <ul class="text-gray-400 font-medium">
                      ...
                      <li class="mb-4">
                          <a href="#" class="hover:underline">Basketball</a>
                      </li>
                      <li class="mb-4">
                          <a href="#" class="hover:underline">Sport Shoes</a>
                      </li>
                      <li class="mb-4">
          ...
          <div class="px-4 py-6 bg-gray-700 md:flex md:items-center md:justify-between">
              <span class="text-sm text-gray-300 sm:text-center">© 2024 <a href="index.php">HOOPS STUFF™</a>. All Rights
                  Reserved.
              </span>
